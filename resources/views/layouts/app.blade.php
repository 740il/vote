            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('question.index') }}">{{ __('All Vote') }}</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('answer.index') }}">{{ __('Result') }}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('question.create') }}">{{ __('Add vote') }}</a>
                        </li>
